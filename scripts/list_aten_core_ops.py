...
def main() -> None:
    ...
    print()
    print(
        "This list shows core ATen operators, whether the codegen backend supports them,"
    ...
    for op_name in aten_ops:
        ...
        print(f"| `{op_name}` | {_format_support_label(op_name in codegen_ops)} | {opinfo_label} |")
