...
static inline bool ref_scalar_bool_logical_and(bool a, bool b) {
    return a && b;
}

static inline bool ref_scalar_bool_logical_xor(bool a, bool b) {
    return a != b;
}

static inline bool ref_scalar_bool_logical_not(bool a) {
    return !a;
}
...
REF_BOOL_UNARY(log)
REF_BOOL_UNARY(acos)
REF_BOOL_UNARY(arccos)
REF_BOOL_UNARY(acosh)
REF_BOOL_UNARY(asin)
REF_BOOL_UNARY(arcsin)
REF_BOOL_UNARY(asinh)
REF_BOOL_UNARY(arcsinh)
REF_BOOL_UNARY(atan)
REF_BOOL_UNARY(arctan)
...
REF_BOOL_UNARY(isfinite)
REF_BOOL_UNARY(isnan)
REF_BOOL_UNARY(log_sigmoid)
REF_BOOL_UNARY(gelu)
REF_BOOL_UNARY(elu)
REF_BOOL_UNARY(leaky_relu)
REF_BOOL_UNARY(softplus)
REF_BOOL_UNARY(rsqrt)
REF_BOOL_UNARY(sigmoid)
REF_BOOL_UNARY(selu)
REF_BOOL_UNARY(relu6)
REF_BOOL_UNARY(hardsigmoid)
REF_BOOL_UNARY(silu)
REF_BOOL_UNARY(mish)
REF_BOOL_UNARY(hardswish)
REF_BOOL_UNARY(sign)
...
REF_BOOL_UNARY(isneginf)
REF_BOOL_UNARY(isposinf)
